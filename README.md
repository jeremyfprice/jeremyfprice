...
- `ceisl-stem/fafi-sna` – *Family as Faculty as Infrastructure: Social Network Analysis* (R)  
- `pi-py` – Python code repository for PECTIN-A project  
- `Digital-Education-Hub/dehsi2021online` – Hugo-site and materials from the 2021 Summer Institute  
- `csais-dashboard` – Dashboard, data analysis and visualisations related to antisemitic incident reporting  
...
## Connect & Collaborate  
- ✉️ Email: `jfprice@iu.edu`  
- LinkedIn: [linkedin.com/in/jeremyfprice](https://www.linkedin.com/in/jeremyfprice)  
- GitHub: [github.com/jeremyfprice](https://github.com/jeremyfprice)  
